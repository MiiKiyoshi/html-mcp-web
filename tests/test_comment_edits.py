...
def test_edits_text_grammar():
    parsed = parse_entry_edits(
        "e-1a2b3c4d@2026-01-01T00:00:00+00:00: first line\n\nsecond: with a colon\n"
        "e-5e6f7a8b@2026-01-01T00:00:01+00:00: other")
    assert parsed == [("e-1a2b3c4d", "2026-01-01T00:00:00+00:00", "first line\n\nsecond: with a colon"),
                      ("e-5e6f7a8b", "2026-01-01T00:00:01+00:00", "other")]
    for bad, error in (("no head here", "holds no edit"), ("x\ne-1a2b3c4d@s: y", "before the first"),
                       ("e-1a2b3c4d@s: ", "is empty"), ("e-1a2b3c4d@s: a\ne-1a2b3c4d@s: b", "at most once")):
